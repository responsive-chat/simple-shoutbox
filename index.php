...
<head>
    ...
    <meta name="description" content="shoutbox.eu.org - &#8470; 1 ქართული ონლაინ ჩატი.">
...
<center><div class="header"><img src="img/logo.png" style="width:100%;" alt="shoutbox.eu.org"></div></center>
...
<form action="<?= htmlentities($_SERVER['PHP_SELF'], ENT_COMPAT, 'UTF-8'); ?>" method="post">
    <p>
        <input type="text" name="content" id="content" maxlength="500" placeholder="შეტყობინება"/>
    </p>
    <p>
        <label>
            <input type="text" name="name" id="name" maxlength="50" placeholder="მეტსახელი" />
        </label>
        <button type="submit"> გაგზავნა </button>
    </p>
</form>
<center><fieldset>
    <legend><font color="#888888">სიცილაკები</font></legend>
...
<br><small><font color="#888888">ადმინისტრატორი:</font></small> <b><font color="#888888">ჰაკერი</font></b><br>
</center>
